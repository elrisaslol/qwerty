...
public class tabla_no_editable_Tropas_Controller extends Controller implements Initializable {
   @FXML
   ...
   private ObservableList<General> generals;
    ...
    @FXML
    private void goToTablaNoEditableCompania() throws IOException {
